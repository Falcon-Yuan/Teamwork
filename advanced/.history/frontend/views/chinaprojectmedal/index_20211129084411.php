...
<header id="site-header" class="position-relative">
    ...
    <!-- BEGIN: .cover -->
    <div class="page-heading-85912" style="background-image: url('images/china.png')">
      <div class="container">
        <div class="row align-items-end">
          <div class="col-lg-7">
            <h1 class="mb-0 heading text-white"><font color="#FF0000">中国项目金牌分布</font> </h1>
...
<div class="chinaprojectmedal-index">
