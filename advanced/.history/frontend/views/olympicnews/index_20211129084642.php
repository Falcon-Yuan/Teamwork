...
<header id="site-header" class="position-relative">
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <!-- BEGIN: .cover -->
        <div class="page-heading-85912" style="background-image: url('images/news.png')">
      <div class="container">
        <div class="row align-items-end">
          <div class="col-lg-7">
            <h1 class="mb-0 heading text-white"><font color="#FF0000">奥运新闻</font> </h1>
